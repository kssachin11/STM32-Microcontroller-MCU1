...
int main(void)
{
	uint32_t *pAdcCr1Reg =   (uint32_t*) ADC_CR1_REG_ADDR; // pointing to address of adc - pointer variable
	...
	*pAdcCr1Reg |= ( 1 << 8); // using pointer variable to program 8th bit of register
}
